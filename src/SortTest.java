...
public class SortTest extends TestCase {
    ...
    /**
     * test sorting with one buffer and one block of Ascii
     * No Time Limit
     */
    public void testSort12() throws Exception{

        final String[] argsFile = {"-a", filename, "1"};
    ...
    /**
     * test sorting with 10 buffer and 10 block of binary
     * No Time Limit
     */
    public void testSort3() throws Exception{
        final String[] argsFile = {"-b", filename, "10"};
        generator.generateFile(argsFile);
    ...
    /**
     * test sorting with 4 buffer and 10 block of binary
     * Generous Time: 420ms
     * Result Time: 61ms
     */
    ...
    /**
     * test sorting with 1 buffer and 10 block of binary
     * Generous Time: 1s
     * Result Time: 259ms
     */
    ...
    /**
     * test sorting with 10 buffer and 100 block of binary
     * Reasonable Time
     * Result: 307ms;
     */
    public void testSort67() throws Exception{
        final String[] argsFile = {"-b", filename, "100"};
        generator.generateFile(argsFile);
        args[1] = "10"; //number of buffers
    ...
    /**
     * test sorting with 10 buffer and 1000 block of binary
     * Tighter Time Limit
     * G: 12.585s
     * R: 4.426s
     * T: 2.445s
    ...
    public void testSort8910() throws Exception{
        final String[] argsFile = {"-b", filename, "1000"};
        generator.generateFile(argsFile);
        args[1] = "10"; //number of buffers
    ...
    /**
     * test sorting with 10 buffer and 1000 block of ASCii
     * Optimization Time Limit
     * G: 4.5s
     * O: 2.445s
     */
    public void testSort1112() throws Exception{
        final String[] argsFile = {"-a", filename, "1000"};
        generator.generateFile(argsFile);
        args[1] = "10"; //number of buffers
